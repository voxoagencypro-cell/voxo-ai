...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const localPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${base}/fr/ia-institut-beaute-geneve`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${base}/fr/ia-salon-coiffure-geneve`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${base}/fr/ia-restaurant-geneve`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${base}/fr/ia-immobilier-geneve`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${base}/fr/ia-garage-automobile-geneve`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
